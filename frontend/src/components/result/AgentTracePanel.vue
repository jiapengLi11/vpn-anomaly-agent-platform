...
const names = { security_admission: "安全准入", tool_router: "工具路由", knowledge_retrieval: "知识检索", analyst_model: "分析模型", claim_gate: "结论门禁", finalize: "结果收敛" };
const descriptions = { security_admission: "限制候选规模并替换地址、域名与路径", tool_router: "按注册表、证据条件与依赖顺序生成工具计划", knowledge_retrieval: "按模型与证据路由检索参考片段", analyst_model: "生成解释和带引用的结构化 Claim", claim_gate: "验证类型、会话和证据引用", finalize: "固定安全结论并封装审计产物" };
