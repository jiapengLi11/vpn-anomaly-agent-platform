    ...
    <main class="workspace-main">
      <header class="workspace-topbar">
        ...
        <div class="topbar-actions">
          <span class="connection-status" :class="{ demo: store.demoMode }"><i />{{ route.path === '/knowledge' ? '资料、文件与问答' : route.path === '/billing' ? '沙箱计费账户' : store.demoMode ? '离线演示 · 只读' : store.backendHealth?.status === 'UP' ? '后端已连接' : '等待服务连接' }}</span>
